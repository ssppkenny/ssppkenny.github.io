...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_12497 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_12497(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_12498 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_12498(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12499 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12499(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12500 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12500(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12502 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12502(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12505 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12505(reader);
}
});
...
var G__12520 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__12521 = s.append(c);
c = G__12520;
s = G__12521;
continue;
}
