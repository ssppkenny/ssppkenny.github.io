...
var G__23030 = o;
reagent.impl.template.goog$module$goog$object.set(G__23030,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__23048__delegate = function (args){
...
while (G__23049__i < G__23049__a.length) {G__23049__a[G__23049__i] = arguments[G__23049__i + 0]; ++G__23049__i;}
  args = new cljs.core.IndexedSeq(G__23049__a,0,null);
} 
return G__23048__delegate.call(this,args);};
G__23048.cljs$lang$maxFixedArity = 0;
G__23048.cljs$lang$applyTo = (function (arglist__23050){
var args = cljs.core.seq(arglist__23050);
return G__23048__delegate(args);
});
...
var G__23031 = o;
reagent.impl.template.goog$module$goog$object.set(G__23031,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__23052__i < G__23052__a.length) {G__23052__a[G__23052__i] = arguments[G__23052__i + 0]; ++G__23052__i;}
  args = new cljs.core.IndexedSeq(G__23052__a,0,null);
} 
...
var G__23032 = props;
var G__23032__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23032,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__23032);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23032__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__23033 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23033,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__23033;
}
})(),id_class);
...
var G__23034 = (cljs.core.count(argv) - first_child);
switch (G__23034) {
case (0):
...
var vec__23035 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23035,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23035,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23035,(2),null);
...
var temp__5808__auto___23055 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23055 == null)){
} else {
var key_23056 = temp__5808__auto___23055;
(jsprops.key = key_23056);
}
...
var temp__5808__auto___23057 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23057 == null)){
} else {
var key_23058 = temp__5808__auto___23057;
(jsprops.key = key_23058);
}
...
var temp__5808__auto___23060 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___23060 == null)){
} else {
var key_23062 = temp__5808__auto___23060;
(jsprops.key = key_23062);
}
...
var temp__5808__auto___23065 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23065 == null)){
} else {
var key_23066 = temp__5808__auto___23065;
(jsprops.key = key_23066);
}
...
var temp__5808__auto___23068 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23068 == null)){
} else {
var key_23069 = temp__5808__auto___23068;
(jsprops.key = key_23069);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23038_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__23038_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__23039 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23039,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23039,(1),null);
...
*/
reagent.impl.template.t_reagent$impl$template23045 = (function (opts,id,fn_to_element,parse_fn,meta23046){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template23045.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23047,meta23046__$1){
var self__ = this;
var _23047__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template23045(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta23046__$1));
}));

(reagent.impl.template.t_reagent$impl$template23045.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23047){
var self__ = this;
var _23047__$1 = this;
return self__.meta23046;
}));

(reagent.impl.template.t_reagent$impl$template23045.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template23045.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template23045.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template23045.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template23045.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template23045.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta23046","meta23046",2036481759,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template23045.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template23045.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template23045");

(reagent.impl.template.t_reagent$impl$template23045.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template23045");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template23045.
 */
reagent.impl.template.__GT_t_reagent$impl$template23045 = (function reagent$impl$template$__GT_t_reagent$impl$template23045(opts,id,fn_to_element,parse_fn,meta23046){
return (new reagent.impl.template.t_reagent$impl$template23045(opts,id,fn_to_element,parse_fn,meta23046));
});
...
return (new reagent.impl.template.t_reagent$impl$template23045(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
