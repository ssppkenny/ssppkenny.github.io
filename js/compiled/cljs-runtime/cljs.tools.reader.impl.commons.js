...
var G__12568 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__12568;
continue;
} else {
return ch;
...
var vec__12560 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12560,(0),null);
return (match === s);
});
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq12566){
...
return (function() { 
var G__12572__delegate = function (rdr,_){
...
var G__12572 = function (rdr,var_args){
var _ = null;
...
while (G__12573__i < G__12573__a.length) {G__12573__a[G__12573__i] = arguments[G__12573__i + 1]; ++G__12573__i;}
  _ = new cljs.core.IndexedSeq(G__12573__a,0,null);
} 
return G__12572__delegate.call(this,rdr,_);};
G__12572.cljs$lang$maxFixedArity = 1;
G__12572.cljs$lang$applyTo = (function (arglist__12574){
var rdr = cljs.core.first(arglist__12574);
var _ = cljs.core.rest(arglist__12574);
return G__12572__delegate(rdr,_);
});
