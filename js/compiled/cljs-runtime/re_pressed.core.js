...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("re-pressed.core","set-keydown-rules","re-pressed.core/set-keydown-rules",1002257871),(function (p__12456,p__12457){
var map__12458 = p__12456;
var map__12458__$1 = cljs.core.__destructure_map(map__12458);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12458__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__12459 = p__12457;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12459,(0),null);
var map__12462 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12459,(1),null);
var map__12462__$1 = cljs.core.__destructure_map(map__12462);
var opts = map__12462__$1;
var event_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12462__$1,new cljs.core.Keyword(null,"event-keys","event-keys",-835966631));
var clear_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12462__$1,new cljs.core.Keyword(null,"clear-keys","clear-keys",-1035470539));
var always_listen_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12462__$1,new cljs.core.Keyword(null,"always-listen-keys","always-listen-keys",497991050));
var prevent_default_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12462__$1,new cljs.core.Keyword(null,"prevent-default-keys","prevent-default-keys",1744205310));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("re-pressed.core","set-keypress-rules","re-pressed.core/set-keypress-rules",1541561860),(function (p__12463,p__12464){
...
var map__12469 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12466,(1),null);
var map__12469__$1 = cljs.core.__destructure_map(map__12469);
var opts = map__12469__$1;
var event_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12469__$1,new cljs.core.Keyword(null,"event-keys","event-keys",-835966631));
var clear_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12469__$1,new cljs.core.Keyword(null,"clear-keys","clear-keys",-1035470539));
var always_listen_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12469__$1,new cljs.core.Keyword(null,"always-listen-keys","always-listen-keys",497991050));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("re-pressed.core","set-keyup-rules","re-pressed.core/set-keyup-rules",519284589),(function (p__12470,p__12471){
var map__12472 = p__12470;
var map__12472__$1 = cljs.core.__destructure_map(map__12472);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12472__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__12473 = p__12471;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12473,(0),null);
var map__12476 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12473,(1),null);
var map__12476__$1 = cljs.core.__destructure_map(map__12476);
var opts = map__12476__$1;
var event_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12476__$1,new cljs.core.Keyword(null,"event-keys","event-keys",-835966631));
var clear_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12476__$1,new cljs.core.Keyword(null,"clear-keys","clear-keys",-1035470539));
var always_listen_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12476__$1,new cljs.core.Keyword(null,"always-listen-keys","always-listen-keys",497991050));
