...
return cljs.core.chunk_cons(cljs.core.chunk(b__12460),pz15$views$main_panel_$_iter__12453_$_iter__12457(cljs.core.chunk_rest(s__12458__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__12460),null);
}
} else {
var vec__12464 = cljs.core.first(s__12458__$2);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12464,(0),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12464,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.cell","div.cell",1471979620),(((!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(n,(0)))))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img","img",1442687358),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"src","src",-1651076051),["images/t",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n),".png"].join(''),new cljs.core.Keyword(null,"width","width",-384071477),"50px",new cljs.core.Keyword(null,"height","height",1025178622),"50px"], null)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img","img",1442687358),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"src","src",-1651076051),"images/empty.png",new cljs.core.Keyword(null,"width","width",-384071477),"50px",new cljs.core.Keyword(null,"height","height",1025178622),"50px"], null)], null))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),pz15$views$main_panel_$_iter__12453_$_iter__12457(cljs.core.rest(s__12458__$2)));
}
} else {
return null;
}
...
});})(i__12455,l,c__5521__auto__,size__5522__auto__,b__12456,s__12454__$2,temp__5804__auto__,show_progress,field,state,solving))
,null,null));
});})(i__12455,l,c__5521__auto__,size__5522__auto__,b__12456,s__12454__$2,temp__5804__auto__,show_progress,field,state,solving))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__12456),pz15$views$main_panel_$_iter__12453(cljs.core.chunk_rest(s__12454__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__12456),null);
}
} else {
var l = cljs.core.first(s__12454__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.row","div.row",133678515),(function (){var iter__5523__auto__ = ((function (l,s__12454__$2,temp__5804__auto__,show_progress,field,state,solving){
return (function pz15$views$main_panel_$_iter__12453_$_iter__12467(s__12468){
return (new cljs.core.LazySeq(null,(function (){
var s__12468__$1 = s__12468;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__12468__$1);
if(temp__5804__auto____$1){
var s__12468__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__12468__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__12468__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__12470 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__12469 = (0);
while(true){
if((i__12469 < size__5522__auto__)){
var vec__12471 = cljs.core._nth(c__5521__auto__,i__12469);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12471,(0),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12471,(1),null);
cljs.core.chunk_append(b__12470,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.cell","div.cell",1471979620),(((!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(n,(0)))))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img","img",1442687358),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"src","src",-1651076051),["images/t",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n),".png"].join(''),new cljs.core.Keyword(null,"width","width",-384071477),"50px",new cljs.core.Keyword(null,"height","height",1025178622),"50px"], null)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img","img",1442687358),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"src","src",-1651076051),"images/empty.png",new cljs.core.Keyword(null,"width","width",-384071477),"50px",new cljs.core.Keyword(null,"height","height",1025178622),"50px"], null)], null))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)));

var G__12479 = (i__12469 + (1));
i__12469 = G__12479;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__12470),pz15$views$main_panel_$_iter__12453_$_iter__12467(cljs.core.chunk_rest(s__12468__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__12470),null);
}
} else {
var vec__12474 = cljs.core.first(s__12468__$2);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12474,(0),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12474,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.cell","div.cell",1471979620),(((!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(n,(0)))))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img","img",1442687358),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"src","src",-1651076051),["images/t",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n),".png"].join(''),new cljs.core.Keyword(null,"width","width",-384071477),"50px",new cljs.core.Keyword(null,"height","height",1025178622),"50px"], null)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img","img",1442687358),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"src","src",-1651076051),"images/empty.png",new cljs.core.Keyword(null,"width","width",-384071477),"50px",new cljs.core.Keyword(null,"height","height",1025178622),"50px"], null)], null))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),pz15$views$main_panel_$_iter__12453_$_iter__12467(cljs.core.rest(s__12468__$2)));
}
} else {
return null;
}
...
});})(l,s__12454__$2,temp__5804__auto__,show_progress,field,state,solving))
;
return iter__5523__auto__(l);
})()], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),pz15$views$main_panel_$_iter__12453(cljs.core.rest(s__12454__$2)));
}
} else {
return null;
}
...
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("pz15.events","solve","pz15.events/solve",-328198452),(1)], null));
