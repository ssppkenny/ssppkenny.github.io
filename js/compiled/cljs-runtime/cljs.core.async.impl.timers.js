...
var i_17236 = (self__.level + (1));
while(true){
if((i_17236 <= (new_level + (1)))){
(update[i_17236] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_17238 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_17238[i]));
} else {
x__$2.forward.push((((i < links_17238.length))?(links_17238[i]):null));
}

if((i < links_17238.length)){
(links_17238[i] = x__$2);
} else {
links_17238.push(x__$2);
}
...
var i_17240 = (0);
while(true){
if((i_17240 <= self__.level)){
var links_17241 = (update[i_17240]).forward;
if((x__$1 === (((i_17240 < links_17241.length))?(links_17241[i_17240]):null))){
(links_17241[i_17240] = (x__$1.forward[i_17240]));

var G__17242 = (i_17240 + (1));
i_17240 = G__17242;
continue;
} else {
var G__17243 = (i_17240 + (1));
i_17240 = G__17243;
continue;
}
} else {
...
var G__17245 = nx;
var G__17246 = (level__$1 - (1));
x = G__17245;
level__$1 = G__17246;
continue;
} else {
var G__17247 = x;
var G__17248 = (level__$1 - (1));
x = G__17247;
level__$1 = G__17248;
continue;
}
