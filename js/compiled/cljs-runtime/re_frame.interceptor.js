...
var i__5770__auto___23902 = (0);
while(true){
if((i__5770__auto___23902 < len__5769__auto___23901)){
args__5775__auto__.push((arguments[i__5770__auto___23902]));

var G__23903 = (i__5770__auto___23902 + (1));
i__5770__auto___23902 = G__23903;
continue;
} else {
}
break;
...
(re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic = (function (p__23838){
var map__23839 = p__23838;
var map__23839__$1 = cljs.core.__destructure_map(map__23839);
var m = map__23839__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23839__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var comment = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23839__$1,new cljs.core.Keyword(null,"comment","comment",532206069));
var before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23839__$1,new cljs.core.Keyword(null,"before","before",-1633692388));
var after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23839__$1,new cljs.core.Keyword(null,"after","after",594996914));
if(re_frame.interop.debug_enabled_QMARK_){
var temp__5802__auto___23904 = cljs.core.seq(clojure.set.difference.cljs$core$IFn$_invoke$arity$variadic(cljs.core.set(cljs.core.keys(m)),re_frame.interceptor.mandatory_interceptor_keys,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([re_frame.interceptor.optional_interceptor_keys], 0)));
if(temp__5802__auto___23904){
var unknown_keys_23905 = temp__5802__auto___23904;
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["re-frame: ->interceptor",m,"has unknown keys:",unknown_keys_23905], 0));
} else {
}
} else {
}

var G__23840 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__5045__auto__ = id;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23840,new cljs.core.Keyword(null,"comment","comment",532206069),comment);
} else {
return G__23840;
}
}));
...
/** @this {Function} */
(re_frame.interceptor.__GT_interceptor.cljs$lang$applyTo = (function (seq23837){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq23837));
}));
...
var args__5775__auto__ = [];
var len__5769__auto___23909 = arguments.length;
var i__5770__auto___23910 = (0);
while(true){
if((i__5770__auto___23910 < len__5769__auto___23909)){
args__5775__auto__.push((arguments[i__5770__auto___23910]));

var G__23912 = (i__5770__auto___23910 + (1));
i__5770__auto___23910 = G__23912;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.interceptor.update_effect.cljs$lang$applyTo = (function (seq23859){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23860,G__23861,G__23862,seq23859__$3);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___23917 = arguments.length;
var i__5770__auto___23918 = (0);
while(true){
if((i__5770__auto___23918 < len__5769__auto___23917)){
args__5775__auto__.push((arguments[i__5770__auto___23918]));

var G__23919 = (i__5770__auto___23918 + (1));
i__5770__auto___23918 = G__23919;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.interceptor.update_coeffect.cljs$lang$applyTo = (function (seq23869){
...
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23870,G__23871,G__23872,seq23869__$3);
}));
...
re_frame.interceptor.invoke_interceptor_fn = (function re_frame$interceptor$invoke_interceptor_fn(p__23877,interceptor,direction){
var map__23878 = p__23877;
var map__23878__$1 = cljs.core.__destructure_map(map__23878);
var context = map__23878__$1;
var original_exception_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23878__$1,new cljs.core.Keyword("re-frame.interceptor","original-exception?","re-frame.interceptor/original-exception?",-527923945));
...
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23888,seq23887__$1);
}));
...
var map__23892 = cljs.core.ex_data(re_frame_error);
var map__23892__$1 = cljs.core.__destructure_map(map__23892);
var event_v = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23892__$1,new cljs.core.Keyword(null,"event-v","event-v",1378681365));
var direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23892__$1,new cljs.core.Keyword(null,"direction","direction",-633359395));
var interceptor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23892__$1,new cljs.core.Keyword(null,"interceptor","interceptor",1127739076));
var event_handler_QMARK_ = (function (){var fexpr__23893 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"fx-handler","fx-handler",-549783097),null,new cljs.core.Keyword(null,"db-handler","db-handler",579530098),null,new cljs.core.Keyword(null,"ctx-handler","ctx-handler",-1777672230),null], null), null);
return (fexpr__23893.cljs$core$IFn$_invoke$arity$1 ? fexpr__23893.cljs$core$IFn$_invoke$arity$1(interceptor) : fexpr__23893.call(null,interceptor));
})();
...
}catch (e23898){var e = e23898;
var G__23899 = cljs.core.ex_cause(e);
var G__23900 = re_frame.interceptor.merge_ex_data.cljs$core$IFn$_invoke$arity$variadic(e,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"event-v","event-v",1378681365),event_v], null)], 0));
return (error_handler.cljs$core$IFn$_invoke$arity$2 ? error_handler.cljs$core$IFn$_invoke$arity$2(G__23899,G__23900) : error_handler.call(null,G__23899,G__23900));
}}
});
