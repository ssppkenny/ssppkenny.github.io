...
return [(function (){var pred__23218 = cljs.core.instance_QMARK_;
var expr__23219 = reactive_val;
if(cljs.core.truth_((pred__23218.cljs$core$IFn$_invoke$arity$2 ? pred__23218.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__23219) : pred__23218.call(null,reagent.ratom.RAtom,expr__23219)))){
return "ra";
} else {
if(cljs.core.truth_((pred__23218.cljs$core$IFn$_invoke$arity$2 ? pred__23218.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__23219) : pred__23218.call(null,reagent.ratom.RCursor,expr__23219)))){
return "rc";
} else {
if(cljs.core.truth_((pred__23218.cljs$core$IFn$_invoke$arity$2 ? pred__23218.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__23219) : pred__23218.call(null,reagent.ratom.Reaction,expr__23219)))){
return "rx";
} else {
if(cljs.core.truth_((pred__23218.cljs$core$IFn$_invoke$arity$2 ? pred__23218.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__23219) : pred__23218.call(null,reagent.ratom.Track,expr__23219)))){
return "tr";
} else {
return "other";
}
