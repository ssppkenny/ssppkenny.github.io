...
var o12531 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12531["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12532 = temp__5802__auto____$1;
return (o12532["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12044__auto__ = f;
return (o__12044__auto__["toString"]).call(o__12044__auto__);
} else {
return "";
}
}catch (e12538){var _ = e12538;
return "";
}});
...
try{var o__12044__auto___12745 = t;
(o__12044__auto___12745["cljs$lang$ctorPrWriter"]).call(o__12044__auto___12745,t,writer);
}catch (e12548){var __12747 = e12548;
}
...
var char_code = (function (){var o__12044__auto__ = (new String(char$));
return (o__12044__auto__["charCodeAt"]).call(o__12044__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12044__auto__ = String;
return (o__12044__auto__["fromCharCode"]).call(o__12044__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12550 = num_code;
switch (G__12550) {
case (1):
return (185);
...
var o__12044__auto__ = String;
return (o__12044__auto__["fromCharCode"]).call(o__12044__auto__,superscript_code);
});
/**
...
}catch (e12573){var _e__12112__auto__ = e12573;
return false;
}})())){
...
var vec__12575 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12575,(0),null);
...
var len__5769__auto___12755 = arguments.length;
var i__5770__auto___12756 = (0);
while(true){
if((i__5770__auto___12756 < len__5769__auto___12755)){
args__5775__auto__.push((arguments[i__5770__auto___12756]));

var G__12757 = (i__5770__auto___12756 + (1));
i__5770__auto___12756 = G__12757;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12592){
var vec__12593 = p__12592;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12593,(0),null);
...
var G__12763 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12764 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12763;
remaining_tokens = G__12764;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12587){
var G__12588 = cljs.core.first(seq12587);
var seq12587__$1 = cljs.core.next(seq12587);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12588,seq12587__$1);
}));
...
var vec__12601 = cljs.core.split_with((function (p1__12600_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12600_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12601,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12601,(1),null);
...
var vec__12613 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12613,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12613,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12770 = cljs.core.rest(remaining_tokens);
var G__12771 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12770;
name_tokens = G__12771;
continue;
} else {
...
var vec__12619 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12619,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12619,(1),null);
var vec__12622 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12622,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12622,(1),null);
var vec__12625 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12625,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12625,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12625,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12625,(3),null);
...
var vec__12633 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12633,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12633,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12633,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12633,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12633,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12633,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12637 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12637,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12637,(1),null);
var vec__12640 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12640,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12640,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12646 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12646) : devtools.munging.parse_fn_info_deep.call(null,G__12646));
})()));
}
} else {
return fn_info;
...
var G__12799 = (arity + (1));
var G__12800 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12650){
var vec__12651 = p__12650;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12651,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12651,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12665_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12665_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12666_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12666_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___12805 = arguments.length;
var i__5770__auto___12806 = (0);
while(true){
if((i__5770__auto___12806 < len__5769__auto___12805)){
args__5775__auto__.push((arguments[i__5770__auto___12806]));

var G__12808 = (i__5770__auto___12806 + (1));
i__5770__auto___12806 = G__12808;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12669){
var vec__12670 = p__12669;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12670,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12667){
var G__12668 = cljs.core.first(seq12667);
var seq12667__$1 = cljs.core.next(seq12667);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12668,seq12667__$1);
}));
...
var map__12682 = options;
var map__12682__$1 = cljs.core.__destructure_map(map__12682);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12682__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12682__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12682__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12682__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12685 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12685,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12685,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12685,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12685,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12685,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12685,(5),null);
...
var o__12044__auto__ = f;
return (o__12044__auto__["getBasis"]).call(o__12044__auto__);
});
/**
...
}catch (e12699){var _e__12112__auto__ = e12699;
...
var G__12815 = (obj[cljs.core.first(path)]);
var G__12816 = cljs.core.rest(path);
obj = G__12815;
path = G__12816;
continue;
} else {
...
var _STAR_ = (function (accum,p__12714){
var vec__12715 = p__12714;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12715,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12715,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12721){
var vec__12723 = p__12721;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12723,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12723,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12723,(2),null);
...
var post_process = (function (p__12727){
var vec__12728 = p__12727;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12728,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12728,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12726_SHARP_){
return (obj[cljs.core.first(p1__12726_SHARP_)]);
}),sorted_matches);
