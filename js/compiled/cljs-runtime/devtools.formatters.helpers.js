...
var G__12811 = devtools.prefs.pref(v);
v = G__12811;
continue;
} else {
return v;
...
}catch (e12775){var _e__12112__auto__ = e12775;
return false;
}})();
...
}catch (e12779){var _e__12112__auto__ = e12779;
return false;
}})();
...
}catch (e12782){var _e__12112__auto__ = e12782;
return false;
}}
}
});
...
var vec__12796 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12796,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12796,(1),null);
...
return cljs.core.some((function (p1__12801_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12801_SHARP_);
}),template);
});
