...
args__5775__auto__.push((arguments[i__5770__auto___12931]));
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12841){
var G__12842 = cljs.core.first(seq12841);
var seq12841__$1 = cljs.core.next(seq12841);
var G__12843 = cljs.core.first(seq12841__$1);
var seq12841__$2 = cljs.core.next(seq12841__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12842,G__12843,seq12841__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12876_SHARP_){
return (!((cljs.core.meta(p1__12876_SHARP_) == null)));
})))){
...
var map__12894 = opts;
var map__12894__$1 = cljs.core.__destructure_map(map__12894);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12894__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12895){var _e__12112__auto__ = e12895;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e12901){var _e__12112__auto__ = e12901;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12906 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12907 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12907);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12908__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12906);
}});
...
var temp__5802__auto___12983 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___12983)){
var managed_print_level_12984 = temp__5802__auto___12983;
var _STAR_print_level_STAR__orig_val__12920_12985 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12921_12986 = managed_print_level_12984;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12921_12986);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12916_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12916_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12920_12985);
}} else {
job_fn();
}
